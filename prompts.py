...
4. Test the running app in a real browser via the Browser MCP tools:
   - start_dev_server(start_command="npm run dev") when the app needs a local server.
   - browser_open then browser_goto (usually http://localhost:5173).
